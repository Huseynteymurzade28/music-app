...
func (r *Router) NewRouter() *mux.Router {
	...
	protected.HandleFunc("/albums", r.CreateAlbumHandler).Methods(http.MethodPost, http.MethodOptions)
	protected.HandleFunc("/albums", r.GetAlbumsHandler).Methods(http.MethodGet, http.MethodOptions)
	protected.HandleFunc("/albums/{id}", r.GetAlbumHandler).Methods(http.MethodGet, http.MethodOptions)
	protected.HandleFunc("/albums/{id}", r.DeleteAlbumHandler).Methods(http.MethodDelete, http.MethodOptions)
	protected.HandleFunc("/albums/{id}/tracks", r.AddTrackToAlbumHandler).Methods(http.MethodPost, http.MethodOptions)
	protected.HandleFunc("/albums/{id}/tracks/{trackId}", r.RemoveTrackFromAlbumHandler).Methods(http.MethodDelete, http.MethodOptions)
	protected.HandleFunc("/search/albums", r.SearchAlbumsHandler).Methods(http.MethodGet, http.MethodOptions)
